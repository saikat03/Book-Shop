...
<body class="profile-page sidebar-collapse">
    ...
    <!-- End Navbar -->
        ...
        <div class="wrapper">
            ...
            <div class="page-header-image" data-parallax="true" style="background-image: url('../assets/img/bg01.jpg');"></div>
                <div class="container">
        ...
        <div class="section">
            <div class="container">
                <div class="button-container">
                    ...
                    <a href="" target="_blank" class="btn btn-default btn-round btn-lg btn-icon" rel="tooltip" title="Follow me on Twitter">
                        <i class="fa fa-twitter"></i>
                    </a>
                    <a href="" target="_blank" class="btn btn-default btn-round btn-lg btn-icon" rel="tooltip" title="Follow me on Instagram">
