              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                      ...
                      <option value="Dhaka city">Uttara</option>
                      <option value="Dhaka city">Khilgaon</option>
                      <option value="Dhaka city">Gulshan</option>
                      <option value="Dhaka city">Tejgaon</option>
                      <option value="Dhaka city">Dhanmondi</option>
                      <option value="Dhaka city">Paltan</option>
                      <option value="Dhaka city">Badda</option>
                      <option value="Dhaka city">Rampura</option>
                      <option value="Dhaka city">Narayanganj</option>
                      <option value="Dhaka city">Gazipur</option>
                      <option value="Dhaka city">Tongi</option>
                      <option value="Cumilla City">Cumilla</option>
                      <option value="Chittagong City">Chittagong</option>
                      <option value="Khulna City">Khulna</option>
                      <option value="Barisal City">Barisal</option>
                      <option value="Chadpur City">Chadpur</option>
                      </select>  
                      </div>
