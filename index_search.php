...
<body class="index-page sidebar-collapse">
    ...
    <div class="wrapper">
        <div class="page-header clear-filter" filter-color="orange">
            <div class="page-header-image" data-parallax="true" style="background-image: url('./assets/img/bg01.jpg');">
            
                <div class="container">
                    <div class="content-center brand">
                        <br><br>
                        <h3>Buy and sell new and old books.</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="main">
            <div class="section section-basic">
                <div class="container">
                    <br>
                    <div class="col-md-12">
                        <h2 class="title">Book Shop' products</h2>
                        <div class="typography-line">
                            <p>
                            Are you a book seller? Or, do you want to sell your used book(s)? Or, do you want to buy new/used book(s)? Book Shop is the perfect market place for buying and selling all kinds of new and used books.
                            </p>
                        </div>
                        <br>
                        ...
                        <ul class="thumbnails">
                            ...
                            <div class="row-sm-3">
                                ...
                                <div class="caption">
                                  ...
                                  <h6><a class="btn btn-success btn-round" title="Click for more details!" href="pages/product_details.php?prod_id=<?php echo $res['prod_id'];?>"><i class="now-ui-icons gestures_tap-01"></i>View</a><medium class="pull-right">TK<?php echo $res['prod_price']; ?></medium></h6>
                                </div>
